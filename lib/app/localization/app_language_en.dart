const Map<String, String> appLanguageEn = {
  ...
  'follow_interface_language': 'Follow interface language',
  'asmr_page_language': 'ASMR.ONE page language',
  ...
  'transient_audio_focus_loss_behavior': 'On brief audio interruption',
  ...
  'asmr_download_path_setting': 'Download path',
  'asmr_download_path_not_set': 'Not set',
  'asmr_download_conflict_setting': 'Duplicate name handling',
  ...
  'startup_playback_restore_behavior': 'Startup playback restore',
  'startup_playback_restore_resume': 'Continue playing',
  'startup_playback_restore_pause': 'Pause',
  'allow_duplicate_works': 'Allow duplicate works in playlist',
  'reduce_animations': 'Reduce animations',
  'haptic_feedback_enabled': 'Interaction haptics',
