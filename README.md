...
最新发布页：[v1.1.14](https://github.com/NameIess-art/AudioPlayer/releases/tag/v1.1.14)
...
从 [GitHub Release v1.1.14](https://github.com/NameIess-art/AudioPlayer/releases/tag/v1.1.14) 下载适合设备 CPU 架构的 APK：
...
- 修复封面图片拉伸问题：`ResizeImage` 只指定单一维度，保持原始宽高比后再裁切填充。
- 修复播放卡片暂停按钮图标在点击时不在圆圈中心的问题。
- 同步版本、README 和 Release 信息到 `1.1.14+10114`，发布 arm64-v8a、armeabi-v7a、x86_64 三个 APK。
