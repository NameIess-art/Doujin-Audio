...
const Map<AppLanguage, Map<String, String>> _localizedValues = {
  AppLanguage.zh: {
    ...
    'dlsite_fetch_failed': '获取DLsite信息失败，请检查RJ号或网络后重试。',
  ...
  AppLanguage.ja: {
    ...
    'dlsite_fetch_failed': 'DLsite情報を取得できませんでした。RJ番号またはネットワークを確認してください。',
  ...
  AppLanguage.en: {
    ...
    'dlsite_fetch_failed':
        'Failed to fetch DLsite info. Check the RJ number or network and try again.',
