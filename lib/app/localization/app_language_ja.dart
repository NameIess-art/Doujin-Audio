const Map<String, String> appLanguageJa = {
  ...
  'follow_interface_language': 'インターフェース言語に従う',
  'asmr_page_language': 'ASMR.ONEページ言語',
  ...
  'about_subtitle': 'アプリ情報、バージョン、作者を表示します。',
  'about_version': 'バージョン',
  'about_source_code': 'ソースコード',
  'about_source_code_subtitle': 'プロジェクトのソースコードを表示します。',
  'about_wiki': 'wiki',
  'about_wiki_subtitle': 'アプリ紹介を表示します。',
  ...
  'haptic_feedback_enabled': '操作時の振動',
