const Map<String, String> appLanguageJa = {
  ...
  'channel_swap_desc': '左右チャンネルの出力を入れ替えます。',
  'skip_silence': '無音スキップ',
  'skip_silence_desc': '再生中の無音部分を短縮',
  'noise_reduction': 'ノイズ低減',
  'noise_reduction_desc': '鋭いノイズや背景音を軽減',
  'volume_normalization': '音量ノーマライズ',
  'volume_normalization_desc': '突発的な大音量を抑え、全体の音量を軽く整えます',
  'audio_features': '機能',
  'equalizer': 'イコライザー',
  'time_segments': '時間区間',
  ...
  'dark_mode': 'ダークモード',
  'dark_mode_subtitle': 'システム、ライト、ダークの外観を選択します。',
  'theme_system': 'システム',
  'theme_light': 'ライト',
  'theme_dark': 'ダーク',
  ...
  'permission_center_subtitle': '任意の権限をまとめて確認できます。対応機能を使う場合のみ有効にしてください。',
  ...
  'data_and_support_subtitle': 'アプリデータのバックアップ、復元、または匿名化された診断レポートを出力します。',
  'export_backup': 'バックアップを出力',
  'export_backup_subtitle': '曲庫データベースと移行可能な設定を含みます。認証情報と音声ファイルは含みません。',
  'restore_backup': 'バックアップを復元',
  'restore_backup_subtitle': 'バックアップを検証してからデータベースと設定を復元します。',
  ...
  'export_diagnostics_subtitle': '匿名化されたログ、バージョン、権限、キャッシュ情報を出力します。自動送信はしません。',
  ...
  'clear_app_cache_subtitle': 'カバー、動画フレーム、更新パッケージ、ダウンロード一時ファイルを削除します。',
  ...
  'check': '確認',
  'check_updates': '更新を確認',
  'check_updates_subtitle': 'GitHub Releases から最新版の更新パッケージを確認してダウンロードします。',
