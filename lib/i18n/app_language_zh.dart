const Map<String, String> appLanguageZh = {
  ...
  'skip_silence': '跳过空白',
  'skip_silence_desc': '播放时缩短较长的无声片段。',
  'noise_reduction': '轻度降噪',
  'noise_reduction_desc': '略微削弱尖锐和沙沙的底噪。',
  'volume_normalization': '音量平衡',
  'volume_normalization_desc': '限制突发大声，并轻微均衡整体音量。',
  'audio_features': '功能',
  'equalizer': '均衡器',
  'time_segments': '时间段',
  ...
  'dark_mode': '深色模式',
  'dark_mode_subtitle': '选择跟随系统、浅色或深色外观。',
  'theme_system': '跟随系统',
  'theme_light': '浅色',
  'theme_dark': '深色',
  ...
  'permission_center_subtitle': '集中查看可选权限状态；仅在使用对应功能时需要开启。',
  ...
  'data_and_support_subtitle': '备份应用数据、恢复备份或导出脱敏诊断报告。',
  'export_backup': '导出备份',
  'export_backup_subtitle': '包含曲库数据库和可迁移设置，不包含账号凭据或音频文件。',
  'restore_backup': '恢复备份',
  'restore_backup_subtitle': '校验备份后恢复数据库和设置。',
  ...
  'export_diagnostics_subtitle': '导出脱敏日志、版本、权限和缓存信息，不会自动上传。',
  ...
  'check': '检查',
  'check_updates': '检查更新',
  'check_updates_subtitle': '从 GitHub Releases 自动检查并下载最新版更新包。',
