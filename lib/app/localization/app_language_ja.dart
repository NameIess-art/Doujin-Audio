const Map<String, String> appLanguageJa = {
  ...
  'follow_interface_language': 'アプリと同じ',
  'asmr_page_language': 'ASMR.ONE 言語',
  ...
  'cover_image_resolution_300': '低（300px）',
  'cover_image_resolution_600': '標準（600px）',
  'cover_image_resolution_900': '高（900px）',
  'cover_image_resolution_original': '元画像',
  'theme_system': 'システム',
  'theme_light': 'ライト',
  'theme_dark': 'ダーク',
  'differentiate_asmr_theme': 'ASMR.ONE 専用カラー',
  'bottom_navigation_style': 'フローティング下部バー',
  ...
  'settings_group_data': 'データ',
  'settings_group_cache': 'キャッシュ',
  'settings_group_permissions': '権限',
  ...
  'startup_playback_restore_behavior': '起動時の再生',
  ...
  'dlsite_metadata_language': 'DLsite 情報の言語',
  'timer_title': 'タイマー',
