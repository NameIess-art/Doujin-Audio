const Map<String, String> appLanguageJa = {
  ...
  'asmr_collected_count': '現在 {count} 作品を収録',
  ...
  'asmr_download_cancel_and_clear': 'ダウンロードをキャンセルしてダウンロード済みの内容を削除',
  ...
  'asmr_download_cancelled_and_cleared': 'ダウンロードをキャンセルし、ダウンロード済みの内容を削除しました',
  ...
  'restore_backup_subtitle': 'ライブラリ、設定、ASMR.ONE アカウントを復元します。再生リストは含まれません。',
  ...
  'startup_playback_restore_behavior': '起動後の再生状態',
