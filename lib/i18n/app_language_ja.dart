const Map<String, String> appLanguageJa = {
  ...
  'cover_image_resolution_subtitle': 'すべてのカバー画像の最大デコードサイズを統一します。',
  ...
  'theme_light': 'ライト',
  'theme_dark': 'ダーク',
  'bottom_navigation_style': '下部メニューバー',
  'bottom_navigation_style_subtitle': '下部ナビゲーションの表示スタイルを選択します。',
  'bottom_navigation_style_capsule': 'カプセル状の外観',
  'bottom_navigation_style_bar': '標準の下部バー',
