...
import com.nameless.audio.channel.AudioPickerCoordinator
import com.nameless.audio.channel.FileCacheTaskExecutor
import com.nameless.audio.channel.FileExportCoordinator
import com.nameless.audio.storage.DocumentStorageOperations
...
private fun setPendingPickerRequest(
    ...
    val modeClass = Class.forName(
        "com.nameless.audio.channel.AudioPickerCoordinator\u0024PickAudioMode",
    )
    val mode = modeClass.enumConstants.first { (it as Enum<*>).name == "folder" }
    val requestClass = Class.forName(
        "com.nameless.audio.channel.AudioPickerCoordinator\u0024PendingPickAudioRequest",
    )
...
private fun setPendingExportRequest(
    ...
    val requestClass = Class.forName(
        "com.nameless.audio.channel.FileExportCoordinator\u0024PendingExportRequest",
    )
    val request = requestClass.declaredConstructors.single().apply {
        isAccessible = true
