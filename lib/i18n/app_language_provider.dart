...
const Map<AppLanguage, Map<String, String>> _localizedValues = {
  ...
  AppLanguage.ja: {
    ...
    'about': '情報',
    'app_version': 'ローカル音楽プレーヤー v1.1.0',
  ...
  AppLanguage.en: {
    ...
    'show_playback_card_subtitle': 'Show the current playback card at the bottom of the screen.',
    ...
    'about': 'About',
    'app_version': 'Local Music Player v1.1.0',
    'app_desc':
