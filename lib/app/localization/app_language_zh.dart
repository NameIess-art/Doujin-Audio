const Map<String, String> appLanguageZh = {
  ...
  'follow_interface_language': '跟随界面语言',
  'asmr_page_language': 'ASMR.ONE页面语言',
  'asmr_language_zh': '中文',
  'asmr_language_ja': '日文',
  'asmr_language_en': '英文',
  ...
  'unexpected_error_title': 'Nameless Audio 遇到意外错误',
  ...
  'about_subtitle': '查看应用信息、版本和作者。',
  'about_version': '版本',
  'about_source_code': '源代码',
  'about_source_code_subtitle': '查看项目源代码。',
  'about_wiki': 'wiki',
  'about_wiki_subtitle': '查看应用介绍。',
  ...
  'haptic_feedback_enabled': '交互震动效果',
  'haptic_feedback_enabled_subtitle': '在应用内操作时提供触觉震动反馈。',
  'dlsite_metadata_language': 'DLsite数据读取语言',
  'dlsite_metadata_language_subtitle': '读取 DLsite 作品信息的语言，默认跟随页面语言。',
  'timer_title': '计时器',
  'set_countdown': '设置倒计时',
  'start_mode': '启动方式',
  ...
  'segment_delete_confirm': '要删除时间段标签“{name}”吗？',
  'segment_loop': '循环播放',
