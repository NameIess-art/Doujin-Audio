...
enum GlassRefreshIndicatorTriggerMode {
...
///  * [GlassRefreshIndicatorState], can be used to programmatically show the refresh indicator.
...
class GlassRefreshIndicator extends StatefulWidget {
  ...
  const GlassRefreshIndicator.adaptive({
    super.key,
    this.displacement = 40.0,
    this.edgeOffset = 0.0,
    required this.onRefresh,
  ...
  const GlassRefreshIndicator.noSpinner({
    super.key,
    required this.onRefresh,
    this.onStatusChange,
    this.notificationPredicate = defaultScrollNotificationPredicate,
  ...
  final ValueChanged<GlassGlassRefreshIndicatorStatus?>? onStatusChange;
  ...
  ///
  /// If this is [GlassRefreshIndicatorTriggerMode.anywhere], both of the cases above can be triggered.
  ///
  /// If this is [GlassRefreshIndicatorTriggerMode.onEdge], only case 1 can be triggered.
  ///
...
class GlassRefreshIndicatorState extends State<GlassRefreshIndicator>
  ...
  GlassGlassRefreshIndicatorStatus? _status;
  ...
  @protected
  @override
  void didUpdateWidget(covariant GlassRefreshIndicator oldWidget) {
  ...
  bool _handleScrollNotification(ScrollNotification notification) {
    ...
    if (indicatorAtTopNow != _isIndicatorAtTop) {
      ...
      switch (_status) {
        ...
        case GlassGlassRefreshIndicatorStatus.snap:
        case null:
          // do nothing
          break;
      }
  ...
  Future<void> _dismiss(GlassGlassRefreshIndicatorStatus newMode) async {
  ...
  void _show() {
    assert(_status != GlassGlassRefreshIndicatorStatus.refresh);
  ...
  ///
  /// Creating the [RefreshIndicator] with a [GlobalKey<GlassRefreshIndicatorState>]
  /// makes it possible to refer to the [GlassRefreshIndicatorState].
  ///
