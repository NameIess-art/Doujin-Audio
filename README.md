...
| 音频库 | 播放列表 | 计时器与设置 |
|---|---|---|
| ![音频库](docs/screenshots/library.png) | ![播放列表](docs/screenshots/sessions.png) | ![计时器与设置](docs/screenshots/timer-settings.png) |
...
- 多会话：AudioProvider 多会话基础行为、原生播放快照会话隔离、乐观播放状态去重。
