...
最新发布页：[v0.12.2](https://github.com/NameIess-art/nameless-audio/releases/tag/v0.12.2)
...
| 平台 | 发布资产 | 说明 |
|---|---|---|
| Android arm64-v8a | `NamelessAudio-android-arm64-v0.12.2.apk` | 适用于大多数 64 位 Android 手机 |
| Windows x64 | `NamelessAudio-windows-x64-v0.12.2.zip` | 解压完整 ZIP 后运行 `nameless_audio.exe` |
