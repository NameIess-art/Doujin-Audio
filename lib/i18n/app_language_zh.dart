const Map<String, String> appLanguageZh = {
  ...
  'cover_image_resolution_subtitle': '统一设置所有封面图片的最大显示解码尺寸。',
  ...
  'theme_light': '浅色',
  'theme_dark': '深色',
  'bottom_navigation_style': '下方菜单栏',
  'bottom_navigation_style_subtitle': '选择底部导航的显示样式。',
  'bottom_navigation_style_capsule': '胶囊状外观',
  'bottom_navigation_style_bar': '普通下方边栏',
