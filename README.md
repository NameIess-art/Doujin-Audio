...
最新发布页：[v1.1.15](https://github.com/NameIess-art/nameless-audio/releases/tag/v1.1.15)
...
- 音量增强：每会话独立音量 0–200%，超过 100% 时弹出警告提示。
...
- **200% 超量警告**：输入值超过 100% 时弹出警告提示，说明可能导致音频失真，需二次确认。
...
从 [GitHub Release v1.1.15](https://github.com/NameIess-art/nameless-audio/releases/tag/v1.1.15) 下载适合设备 CPU 架构的 APK：
